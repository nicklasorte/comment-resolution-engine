    ...
    for idx, row in df.iterrows():
        ...
        records.append(
            CommentRecord(
                ...
                commenter=_clean_str(data.get("reviewer_initials")),
                agency=_clean_str(data.get("agency")),
                source_agency=_clean_str(data.get("agency")),
                revision=revision_value,
                report_version=_clean_str(data.get("report_version")),
                section=_clean_str(data.get("section")),
                target_section=_clean_str(data.get("section")),
                page=_to_int(data.get("page")),
                line=_to_int(data.get("line")) or _to_int(data.get("line_number")),
                target_page=_clean_str(data.get("page")),
                target_line=_clean_str(data.get("line") or data.get("line_number")),
                comment_type=_clean_str(data.get("comment_type")),
                comment_category=_clean_str(data.get("comment_type")),
                agency_notes=_clean_str(data.get("agency_notes")),
                comment_text=_clean_str(data.get("agency_notes")),
                agency_suggested_text=_clean_str(data.get("agency_suggested_text")),
                proposed_change=_clean_str(data.get("agency_suggested_text")),
                ...
                response_text=_clean_str(data.get("resolution")),
                resolution_summary=_clean_str(data.get("resolution") or data.get("resolution_basis") or data.get("agency_notes")),
                reason_code=_clean_str(data.get("reason_code")),
