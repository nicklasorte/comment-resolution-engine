...
- Extracts line-reference-aware report context from a PDF when line numbers are available (best effort, non-blocking).
...
- `Proposed Report Text` is intentionally left blank; populate it via future LLM integration or analyst drafting.
