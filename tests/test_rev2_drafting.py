...
from comment_resolution_engine.models import AnalyzedComment, ResolutionDecision, SharedResolution
...
def test_rev2_pipeline_outputs_rewrites_and_draft(tmp_path: Path):
    ...
    assert "remain unchanged" in draft_text
...
def test_rev2_modes_and_validation_differ():
    ...
    assert "1.0" in validated.revised_text
